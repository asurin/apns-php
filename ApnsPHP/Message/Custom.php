...
class ApnsPHP_Message_Custom extends ApnsPHP_Message
{
	 ...
	 * to use for the right buttonâs title instead of "View". If the value is an
	 ...
	 * localization (which is set by the userâs language preference).
	 *
	 ...
	 * key in the applicationâs Info.plist file, or falls back to Default.png.
